                        ...
                        <div class="card mg-b-20">
                            <div class="card-header pb-0">
                                <div class="col-sm-6 col-md-4 col-xl-3">
                                    <a class="modal-effect btn btn-outline-primary btn-block" href="invoices/create">أضافة فاتورة</a>
                                </div>
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div  class="dropdown-menu tx-13">
                                                            <a class="dropdown-item" href="{{ url('edit_invoice', [$invoice->id]) }}">
                                                                <i class="text-default fas fa-edit "></i>
                                                                تعديل الفاتورة
                                                            </a>
                                                            ...
                                                            <i class="fas fa-money-bill"></i>  تغيير حاله الدفع</i>
                                                        </a>
                                                        </div>
                                                    </div>
