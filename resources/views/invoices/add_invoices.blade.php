                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                ...
                                                <select name="products" id="product" class="form-control"></select>
                                            </div>
                                            <div class="col">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                ...
                                                <input type="text" class="form-control form-control-lg" id="discount"
                                                    name="discount" title="يرجي ادخال الخصم "  value= 0 >
                                            </div>
                                            <div class="col">
                                        ...
                                        <br>
                                            ...
                                            <label for="" class="card-title"> مرفقات</label>
                                            <div class="col-sm-12 col-md-12">
                                                <input type="file" class="dropify" accept=".png , .jpg , .pdf , image/jpeg , image/png" name="attachment"
                                                data-height="70">
                                            </div>
