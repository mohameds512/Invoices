							...
							<div class="card card-invoice">
								<div class="card-body">
									<div class="invoice-header">
										<h1 class="invoice-title">طباعة فاتورة</h1>
										<div class="billed-from">
											<h6>الفواتير</h6>
											<p>شارع جيهان , حي الجامعه , المنصورة<br>
											Tel No: 0102 6993 056<br>
											Email: mhmde6373@gmail.com</p>
										</div><!-- billed-from -->
									</div><!-- invoice-header -->
									<div class="row mg-t-20">
										...
										<div class="col-md">
											...
											<p class="invoice-info-row"><span> رقم الفاتورة</span> <span>{{$invoice->invoices_number}} </span></p>
											<p class="invoice-info-row"><span>  : تاريخ الاصدار</span> <span>{{$invoice->invoices_date}}</span></p>
										...
										<table class="table table-invoice border text-md-nowrap mb-0">
											...
											<tbody>
												<tr>
													...
													<td class="valign-middle" colspan="2" rowspan="4">
														<div class="invoice-notes">
															<label class="main-content-label tx-13">معلومات الفاتورة</label>

														</div><!-- invoice-notes -->
													</td>
													<td class="tx-right">حالة الفاتورة</td>
													<td class="tx-right tx-bold" colspan="2">{{$invoice->status}}</td>
												</tr>
												<tr>
												...
												<tr>
													...
													<td class="tx-primary tx-bold" colspan="2">{{$invoice->total}}</td>
												</tr>
											</tbody>
										</table>
									</div>
